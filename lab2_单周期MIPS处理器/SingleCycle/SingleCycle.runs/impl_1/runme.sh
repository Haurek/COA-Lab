...
HD_PWD='D:/Github/COA_Lab/lab2/SingleCycle/SingleCycle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIPS_Top.tcl -notrace
